...
export const CreateButton = () =>{
    return (
        ...
        hover:bg-blue-800 px-5 py-[9px] rounded-sm text-sm">
            <IoAddSharp size={20} />
            Create
        </Link>
    )
...
export const SubmitButton = ({label}:{label : string}) => {
    ...
    const className = clsx('text-white bg-blue-700 hover:bg-blue-800 font-medium tounded-sm text-sm w-full px-5 py-3 text-center',
